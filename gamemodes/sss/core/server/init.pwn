...
// ITEM TYPE DEFINITIONS
	...
	*/
	...
	DefineItemTypeAmmo(item_Ammo50,				"Expressa",			calibre_50cae,	1.0,	1.5,	0.9,	28);
	...
	DefineItemTypeAmmo(item_Ammo556Tracer,		"Marcador",			calibre_556,	0.9,	1.1,	0.5,	30);
	DefineItemTypeAmmo(item_Ammo556HP,			"Ponta oca",		calibre_556,	1.3,	1.6,	0.4,	30);
	DefineItemTypeAmmo(item_Ammo357Tracer,		"Marcador",			calibre_357,	1.2,	1.1,	0.6,	10);
