...
{
	dbg("global", LOG_CORE, "[OnPlayerConnect] in /gamemodes/sss/core/char/medical.pwn");
...
{
	dbg("global", LOG_CORE, "[OnItemCreate] in /gamemodes/sss/core/char/medical.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerKeyStateChange] in /gamemodes/sss/core/char/medical.pwn");
...
{
	dbg("global", LOG_CORE, "[OnItemNameRender] in /gamemodes/sss/core/char/medical.pwn");
...
{
	dbg("global", LOG_CORE, "[OnHoldActionUpdate] in /gamemodes/sss/core/char/medical.pwn");
...
{
	dbg("global", LOG_CORE, "[OnHoldActionFinish] in /gamemodes/sss/core/char/medical.pwn");
