...
{
	dbg("global", LOG_CORE, "[OnPlayerConnect] in /gamemodes/sss/core/char/holster.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerKeyStateChange] in /gamemodes/sss/core/char/holster.pwn");
...
{
	dbg("global", LOG_CORE, "[OnItemAddToInventory] in /gamemodes/sss/core/char/holster.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerPickUpItem] in /gamemodes/sss/core/char/holster.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerGiveItem] in /gamemodes/sss/core/char/holster.pwn");
