...
#define DIRECTORY_PLAYER			DIRECTORY_MAIN"players/"
...
{
	dbg("global", LOG_CORE, "[OnPlayerConnect] in /gamemodes/sss/core/player/save-load.pwn");
...
hook OnScriptExit()
{
	dbg("global", LOG_CORE, "[OnScriptExit] in /gamemodes/sss/core/player/save-load.pwn");
	...
	//Close open modio sessions for player data.
	foreach(new i : Player)
	{
		...
		log(DISCORD_CHANNEL_DEV, "Closing file '%s' for playerid: %d (session: %d)", filename, i, session);
