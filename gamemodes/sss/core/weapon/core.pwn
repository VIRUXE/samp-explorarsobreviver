...
{
	dbg("global", LOG_CORE, "[OnPlayerConnect] in /gamemodes/sss/core/weapon/core.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUpdate] in /gamemodes/sss/core/weapon/core.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerWeaponShot] in /gamemodes/sss/core/weapon/core.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerHolsteredItem] in /gamemodes/sss/core/weapon/core.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUnHolsteredItem] in /gamemodes/sss/core/weapon/core.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerKeyStateChange] in /gamemodes/sss/core/weapon/core.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerDropItem] in /gamemodes/sss/core/weapon/core.pwn");
...
{
	dbg("global", LOG_CORE, "[OnItemNameRender] in /gamemodes/sss/core/weapon/core.pwn");
