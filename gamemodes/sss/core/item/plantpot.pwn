...
{
	dbg("global", LOG_CORE, "[OnPlayerUseItemWithItem] in /gamemodes/sss/core/item/plantpot.pwn");
...
{
	dbg("global", LOG_CORE, "[OnItemCreateInWorld] in /gamemodes/sss/core/item/plantpot.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUseItem] in /gamemodes/sss/core/item/plantpot.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerPickUpItem] in /gamemodes/sss/core/item/plantpot.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerDroppedItem] in /gamemodes/sss/core/item/plantpot.pwn");
...
{
	dbg("global", LOG_CORE, "[OnItemDestroy] in /gamemodes/sss/core/item/plantpot.pwn");
