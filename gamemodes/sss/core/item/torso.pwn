...
{
	dbg("global", LOG_CORE, "[OnPlayerConnect] in /gamemodes/sss/core/item/torso.pwn");
...
{
	dbg("global", LOG_CORE, "[OnItemCreateInWorld] in /gamemodes/sss/core/item/torso.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUseItemWithItem] in /gamemodes/sss/core/item/torso.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUseItem] in /gamemodes/sss/core/item/torso.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerKeyStateChange] in /gamemodes/sss/core/item/torso.pwn");
...
{
	dbg("global", LOG_CORE, "[OnHoldActionFinish] in /gamemodes/sss/core/item/torso.pwn");
