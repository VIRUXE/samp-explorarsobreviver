...
{
	dbg("global", LOG_CORE, "[OnPlayerKeyStateChange] in /gamemodes/sss/core/world/workbench.pwn");
...
{
	dbg("global", LOG_CORE, "[OnHoldActionFinish] in /gamemodes/sss/core/world/workbench.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerConstruct] in /gamemodes/sss/core/world/workbench.pwn");
