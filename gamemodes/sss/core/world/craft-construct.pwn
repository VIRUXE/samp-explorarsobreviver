...
{
	dbg("global", LOG_CORE, "[OnPlayerConnect] in /gamemodes/sss/core/world/craft-construct.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUseItem] in /gamemodes/sss/core/world/craft-construct.pwn");
...
{
	dbg("global", LOG_CORE, "[OnHoldActionFinish] in /gamemodes/sss/core/world/craft-construct.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerKeyStateChange] in /gamemodes/sss/core/world/craft-construct.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerCraft] in /gamemodes/sss/core/world/craft-construct.pwn");
