...
{
	dbg("global", LOG_CORE, "[OnPlayerConnect] in /gamemodes/sss/core/world/scrap-machine.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUseMachine] in /gamemodes/sss/core/world/scrap-machine.pwn");
...
{
	dbg("global", LOG_CORE, "[OnHoldActionUpdate] in /gamemodes/sss/core/world/scrap-machine.pwn");
