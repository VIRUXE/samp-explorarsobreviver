...
{
	dbg("global", LOG_CORE, "[OnPlayerConnect] in /gamemodes/sss/core/world/refine-machine.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUseMachine] in /gamemodes/sss/core/world/refine-machine.pwn");
...
{
	dbg("global", LOG_CORE, "[OnItemAddToContainer] in /gamemodes/sss/core/world/refine-machine.pwn");
...
{
	dbg("global", LOG_CORE, "[OnHoldActionUpdate] in /gamemodes/sss/core/world/refine-machine.pwn");
