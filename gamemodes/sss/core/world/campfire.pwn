...
{
	dbg("global", LOG_CORE, "[OnItemCreateInWorld] in /gamemodes/sss/core/item/campfire.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerPickedUpItem] in /gamemodes/sss/core/item/campfire.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUseItemWithItem] in /gamemodes/sss/core/world/campfire.pwn");
