...
{
	dbg("global", LOG_CORE, "[OnPlayerConnect] in /gamemodes/sss/core/world/safebox.pwn");
...
{
	dbg("global", LOG_CORE, "[OnItemCreate] in /gamemodes/sss/core/world/safebox.pwn");
...
{
	dbg("global", LOG_CORE, "[OnItemCreateInWorld] in /gamemodes/sss/core/world/safebox.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUseItem] in /gamemodes/sss/core/world/safebox.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUseItemWithItem] in /gamemodes/sss/core/world/safebox.pwn");
