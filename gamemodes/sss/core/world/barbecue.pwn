...
{
	dbg("global", LOG_CORE, "[OnItemCreate] in /gamemodes/sss/core/world/barbecue.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUseItemWithItem] in /gamemodes/sss/core/world/barbecue.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerPickUpItem] in /gamemodes/sss/core/world/barbecue.pwn");
