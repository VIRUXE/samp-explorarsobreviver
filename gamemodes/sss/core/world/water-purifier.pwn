...
{
	dbg("global", LOG_CORE, "[OnPlayerConnect] in /gamemodes/sss/core/world/water-purifier.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerUseMachine] in /gamemodes/sss/core/world/water-purifier.pwn");
...
{
	dbg("global", LOG_CORE, "[OnItemAddToContainer] in /gamemodes/sss/core/world/water-machine.pwn");
...
{
	dbg("global", LOG_CORE, "[OnHoldActionUpdate] in /gamemodes/sss/core/world/water-machine.pwn");
