...
{
	dbg("global", LOG_CORE, "[OnPlayerSpawn] in /gamemodes/sss/core/admin/hack-detect.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerStateChange] in /gamemodes/sss/core/admin/hack-detect.pwn");
...
{
	dbg("global", LOG_CORE, "[OnPlayerWeaponShot] in /gamemodes/sss/core/admin/hack-detect.pwn");
