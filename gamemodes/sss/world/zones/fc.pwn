...
FC_District_Chilliad()
{
	log(false, "[WORLD] Loading 'FC_District_Chilliad'...");
...
FC_District_AngelPine()
{
	log(false, "[WORLD] Loading 'FC_District_AngelPine'...");
...
FC_District_Scrapyard()
{
	log(false, "[WORLD] Loading 'FC_District_Scrapyard'...");
...
FC_District_Farms()
{
	log(false, "[WORLD] Loading 'FC_District_Farms'...");
...
FC_District_EasterChem()
{
	log(false, "[WORLD] Loading 'FC_District_EasterChem'...");
...
FC_District_FallenTree()
{
	log(false, "[WORLD] Loading 'FC_District_FallenTree'...");
...
FC_District_FlintGen()
{
	log(false, "[WORLD] Loading 'FC_District_FlintGen'...");
