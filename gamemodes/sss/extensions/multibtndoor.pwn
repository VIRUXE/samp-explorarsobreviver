...
hook OnGameModeInit()
{
	d:3:GLOBAL_DEBUG("[OnGameModeInit] in extensions/multibtndoor.pwn");
...
{
	d:3:GLOBAL_DEBUG("[OnMultiButtonTrigger] in /gamemodes/sss/extensions/multibtndoor.pwn");

	d:3:GLOBAL_DEBUG("[OnMultiButtonTrigger] in extensions/multibtndoor.pwn");
...
{
	d:3:GLOBAL_DEBUG("[OnButtonPress] in /gamemodes/sss/extensions/multibtndoor.pwn");

	d:3:GLOBAL_DEBUG("[OnButtonPress] in extensions/multibtndoor.pwn");
